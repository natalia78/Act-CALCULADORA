...
public class MainActivity extends Activity {
    ...
    {  	
		...
		case 4:	// Sen
			try
			{
				double _valorseno = Math.sin(Double.parseDouble(_edit.getText().toString()));
				_edit.setText(String.valueOf(_valorseno));
			}
			catch (Exception e)
			{
				_edit.setTextColor(Color.RED);
		...
		case 5:	// Cos
			try
			{
				double _valorcoseno = Math.cos(Double.parseDouble(_edit.getText().toString()));
				_edit.setText(String.valueOf(_valorcoseno));
			}
			catch (Exception e)
			{
				_edit.setTextColor(Color.RED);
		...
		case 6:	// Tan
			try
			{
				double _valortangente = Math.tan(Double.parseDouble(_edit.getText().toString()));
				_edit.setText(String.valueOf(_valortangente));
			}
			catch (Exception e)
			{
				_edit.setTextColor(Color.RED);
		...
		case 7:	// Raiz
			try
			{
				double _valorraiz = Math.sqrt(Double.parseDouble(_edit.getText().toString()));
				_edit.setText(String.valueOf(_valorraiz));
			}
			catch (Exception e)
			{
				_edit.setTextColor(Color.RED);
